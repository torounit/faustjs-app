...
export const generatedSchema = {
  query: {
    ...
    book: {
      __type: "Book",
      __args: { id: "ID!", idType: "BookIdType", asPreview: "Boolean" },
    },
    bookBy: {
      __type: "Book",
      __args: { id: "ID", bookId: "Int", uri: "String", slug: "String" },
    },
    books: {
  ...
  mutation: {
    __typename: { __type: "String!" },
    createBook: {
      __type: "CreateBookPayload",
      __args: { input: "CreateBookInput!" },
    },
    createCategory: {
    ...
    deleteBook: {
      __type: "DeleteBookPayload",
      __args: { input: "DeleteBookInput!" },
    },
    deleteCategory: {
    ...
    updateBook: {
      __type: "UpdateBookPayload",
      __args: { input: "UpdateBookInput!" },
    },
    updateCategory: {
  ...
  Rabbit: {
    ...
    rabbitId: { __type: "Int!" },
    relation: {
      __type: "RabbitToRabbitConnection",
      __args: { first: "Int", last: "Int", after: "String", before: "String" },
    },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  RabbitToRabbitConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RabbitToRabbitConnectionEdge]" },
    nodes: { __type: "[Rabbit]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RabbitToRabbitConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Rabbit" },
  },
...
export interface Rabbit
  ...
  relation: (args?: {
     ...
     */;
    before?: Maybe<Scalars["String"]>;
  }) => Maybe<RabbitToRabbitConnection>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the rabbit type and the rabbit type
 */
export interface RabbitToRabbitConnection {
  __typename?: "RabbitToRabbitConnection";
  /**
   * Edges for the RabbitToRabbitConnection connection
   */
  edges?: Maybe<Array<Maybe<RabbitToRabbitConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface RabbitToRabbitConnectionEdge {
  __typename?: "RabbitToRabbitConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface SchemaObjectTypes {
  ...
  RabbitToRabbitConnection: RabbitToRabbitConnection;
  RabbitToRabbitConnectionEdge: RabbitToRabbitConnectionEdge;
